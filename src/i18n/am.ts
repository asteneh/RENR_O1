...
const am: Record<string, string> = {
  ...
  postItem: 'እቃ ይለጥፉ',
  postForRent: 'ለኪራይ ይለጥፉ',
  postForSale: 'ለሽያጭ ይለጥፉ',
  postRequest: 'ጥያቄ ይለጥፉ',
  requestToBuy: 'የመግዛት ጥያቄ',
  requestToRent: 'የኪራይ ጥያቄ',
  postJob: 'ስራ ይለጥፉ',
  lookingForJob: 'ስራ እየፈለጉ ነው',
  activities: 'እንቅስቃሴዎች',
  ...
  follow: 'ተከተል',
  posts: 'ልጥፎች',
  noPostsYet: 'ምንም ዝርዝሮች አልተገኙም',
  noActiveItems: 'ይህ ተጠቃሚ በዚህ ምድብ ውስጥ ምንም ንቁ እቃዎች የሉትም።',
  user: 'ተጠቃሚ',
